...
def train_rff_kernel_svm(X, y, c, scale=False, svm_kernel_gamma=None, df_shape='ovr'):
    model = SVC(kernel='rbf', gamma='scale' if (svm_kernel_gamma is None) else svm_kernel_gamma,
                C=c, max_iter=2000, random_state=RANDOM_STATE, cache_size=10240, decision_function_shape=df_shape)
