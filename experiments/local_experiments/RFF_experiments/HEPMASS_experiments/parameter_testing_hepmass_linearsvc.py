...
if __name__ == '__main__':
    ...
    model = LinearSVC(C=0.5, dual=False, random_state=RANDOM_STATE)
    ...
    # Linear SVC with RFF
    model_rff = make_pipeline(RBFSampler(gamma=0.000244141, n_components=905, random_state=RANDOM_STATE),
