...
from experiments.local_experiments.RFF_experiments.MiscScripts.LinearSVCSampledRFF import LinearSVCSampledRFF
...
if __name__ == '__main__':
    ...
    print('writing results to file...')
    write_csv(path=os.path.join(ts_folder, '../Results/'), name='param_tune_linearsvc_rff_', start_time=start_time,
