...
if __name__ == '__main__':
    ...
    file_path = '../../../../data/SYNTHETIC3/SYNTHETIC_DATA.csv'
    ...
    write_csv(path='./Results/', name='param_tune_linearsvc_synthetic2', start_time=start_time,
    ...
    print('writing results to file...')
    write_csv(path='./Results/', name='param_tune_linearsvc_rff_synthetic2_', start_time=start_time,
