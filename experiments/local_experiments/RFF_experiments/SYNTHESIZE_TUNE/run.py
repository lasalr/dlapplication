...
DATASET_SIZE = 5_000_0
DIM = 5
POLY_DEG = 3
DATA_LABEL_COL = 0
TUNE_DATA_FRACTION = 0.5
...
if __name__ == '__main__':
    ...
    for xy in xy_noises:
        ...
        print('Experiment {} Tuned parameters\nsvc_best_params={} score={}\nsvc_rff_best_params={} score={}'.format(idx,
                                                                                                                    svc_best_params,
                                                                                                  svc_best_score,
                                                                                                  svc_rff_best_params,
                                                                                                  svc_rff_best_score))

    # n_comps1 = list(reversed([i for i in range(2, 1100, 300)]))
